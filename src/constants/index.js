...
export const experiences = [
  ...
  },
  {
    ...
    icon: palgharcity48,
    iconBg: "#fbc3bc",
    date: "Mar 2025 - 31 2025",
    points: [
      "Implemented dynamic routing for seamless navigation.",
      "Developed reusable components for consistent UI.",
      "Managed state using React Context and custom hooks.",
      "Integrated theming with light/dark mode support.",
...
export const projects = [
  {
    ...
    description:
      "This application enables users to monitor real-time cryptocurrency prices and receive alerts based on price fluctuations. The backend is optimized with a caching mechanism to ensure efficient and fast responses. The application interacts with a cryptocurrency API (CoinGecko API) to retrieve price data.",
  ...
  },
  {
    ...
    name: "NGO",
    description:
      "Developed a website for an NGO to facilitate the online display and sale of their products. The platform allows users to browse and purchase items, promoting the NGO initiatives, while transactions are handled through offline payment methods to simplify operations.",
  ...
  },
  {
    ...
    name: "Modern UI/UX",
    description:
      "Conceptualized and designed a visually appealing and intuitive frontend interface inspired by modern design principles. The theme emphasizes user engagement, ease of navigation, and a sleek aesthetic, making it ideal for dynamic web and mobile applications.",
  ...
  },
  {
    ...
    name: " KnowJoy",
    description:
      "Developed an engaging entertainment website catering to diverse interests. The platform includes a variety of fun and interactive content such as jokes, riddles, and cocktail recipes, among other features. It is designed to provide users with a joyful and relaxing browsing experience.",
